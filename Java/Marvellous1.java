...
interface Circle
{
	...
	float CalculateArea(float Radius);	//public abstract CalculateArea(float Radius);
	float CalculateCircumference(float Radius);		//public abstract CalculateCircumference(float Radius);
